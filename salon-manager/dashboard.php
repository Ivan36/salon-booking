		...
		<div id="page-wrapper" class="row calender widget-shadow">
			<div class="main-page">
				...
				<div class="row calender widget-shadow">
					<div class="row-one">
						...
						<div class="col-md-4 widget states-mdl">
							<?php $query2=mysqli_query($con,"SELECT * from tblappointment where sid='$sid'");
						...
						<div class="col-md-4 widget states-last">
							<?php $query3=mysqli_query($con,"SELECT * from tblappointment where sid='$sid' AND Status='1'");
				...
				<div class="row calender widget-shadow">
					<div class="row-one">
						<div class="col-md-4 widget">
							<?php $query4=mysqli_query($con,"SELECT * from tblappointment where sid='$sid' AND Status='2'");
						...
						<div class="col-md-4 widget states-mdl">
							<?php $query5=mysqli_query($con,"SELECT * from  tblservices where sid='$sid'");
...
//todays sale
							$query6=mysqli_query($con,"SELECT tblinvoice.ServiceId as ServiceId, tblservices.Cost
								from tblinvoice 
								join tblservices  on tblservices.ID=tblinvoice.ServiceId where tblinvoice.sid='$sid' AND date(PostingDate)=CURDATE();");
...
//Yesterday's sale
							$query7=mysqli_query($con,"SELECT tblinvoice.ServiceId as ServiceId, tblservices.Cost
								from tblinvoice 
								join tblservices  on tblservices.ID=tblinvoice.ServiceId where tblinvoice.sid='$sid' AND date(PostingDate)=CURDATE()-1;");
...
//Last Sevendays Sale
							$query8=mysqli_query($con,"SELECT tblinvoice.ServiceId as ServiceId, tblservices.Cost
								from tblinvoice 
								join tblservices  on tblservices.ID=tblinvoice.ServiceId where tblinvoice.sid='$sid' AND date(PostingDate)>=(DATE(NOW()) - INTERVAL 7 DAY);");
...
//Total Sale
							$query9=mysqli_query($con,"SELECT tblinvoice.ServiceId as ServiceId, tblservices.Cost
								from tblinvoice 
								join tblservices  on tblservices.ID=tblinvoice.ServiceId where tblinvoice.sid='$sid'");
