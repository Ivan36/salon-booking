    ...
    <div class="navbar-collapse">
      <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
        <ul class="nav" id="side-menu">
          ...
          <li>
            <a href="add-services.php"><i class="fa fa-cogs nav_icon"></i>Salon & Services<span class="fa arrow"></span> </a>
            <ul class="nav nav-second-level collapse">
              <li>
                <a href="salon-manager-list.php"> Manager my salon</a>
              </li>
              <li>
          ...
          <li>
            <a href="add-customer.php"><i class="fa fa-users nav_icon"></i>Customer Details<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level collapse">
          ...
          <li>
            <a href="sales-reports.php"><i class="fa fa-folder-open nav_icon"></i>Reports<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level collapse">
        ...
        <li>
          <a href="search-appointment.php"><i class="fa fa-search nav_icon"></i>Search<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level collapse">
            <li><a href="search-appointment.php" >Search Appointment</a></li>

            <li> <a href="search-invoices.php">Search Invoice</a></li>
          </ul>
          <!-- //nav-second-level -->
        </li>
      </ul>
