...
$ret=mysqli_query($con,"SELECT username from tblmanager where id='$adid'");
  ...
  <div class="header-right">
    <div class="profile_details_left"><!--notifications of menu start -->
      <ul class="nofitications-dropdown">
        <?php
        $ret1=mysqli_query($con,"SELECT ID,Name from  tblappointment where sid='$sid' && Status=''");
        ...
        <li class="dropdown profile_details_drop">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            <div class="profile_img"> 
              <span class="prfil-img"><img src="images/suzan.jpg" alt="" width="50" height="60"> </span> 
              <div class="user-name">
                <p><?php echo $name; ?></p>
                <span>Manager</span>
              </div>
