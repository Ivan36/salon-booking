...
if (strlen($_SESSION['bpmsaid']==0)) {
	...
	if(isset($_POST['submit'])){
		...
		for($i=0;$i<count($sid);$i++){
			$svid=$sid[$i];
			$ret=mysqli_query($con,"INSERT into tblinvoice(Userid,ServiceId,BillingId,sid) values('$uid','$svid','$invoiceid','$salon_id');");
						...
						<div class="table-responsive bs-example widget-shadow">
							...
							<form method="post">
								<table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Service Name</th> <th>Service Price</th> <th>Action</th> </tr> </thead> <tbody>
									...
									<tr>
										<input type="hidden" name="salon_id" value="<?php echo $sid; ?>">
