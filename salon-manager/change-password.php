...
if (strlen($_SESSION['bpmsaid']==0)) {
	...
	if(isset($_POST['submit']))
	{
		...
		$query=mysqli_query($con,"SELECT id from tblmanager where id='$adminid' and password='$cpassword'");
		$row=mysqli_fetch_array($query);
		if($row>0){
			$ret=mysqli_query($con,"UPDATE tblmanager set password='$newpassword' where id='$adminid'");
