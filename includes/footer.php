    ...
    <div class="row mb-5">
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          <h2 class="ftco-heading-2 logo">OSBS</h2>
          <?php
          ...
          while ($row=mysqli_fetch_array($ret)) {
            ...
            ?>
            <p><?php  echo substr($row['PageDescription'],0,2000);?></p><?php } ?>
         ...
         <div class="block-23 mb-3">
          ...
          while ($row=mysqli_fetch_array($ret)) {
            ...
            <ul>
             ...
             <li><a href="#"><span class="icon icon-phone"></span><span class="text">+256<?php  echo $row['MobileNumber'];?></span></a></li>
 ...
 <div class="row">
  <div class="col-md-12 text-center">
    ...
    <p>
    <?php echo date("Y"); ?> &copy; online salon booking system </p>
  </div>
</div>
</div>
</footer>