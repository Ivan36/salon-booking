    ...
    <div class="navbar-collapse">
      <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
        <ul class="nav" id="side-menu">
          ...
          <li>
            <a href="add-manager.php"><i class="fa fa-cogs nav_icon"></i>Salons & Accounts<span class="fa arrow"></span> </a>
            <ul class="nav nav-second-level collapse">
              <li>
                <a href="add-manager.php">Add Manager account</a>
              </li>
              <li>
                <a href="add-salons.php">Add salons</a>
              </li>
              <li>
                <a href="salon-manager-list.php">salons Manager list</a>
              </li>
              <li>
                <a href="manage-salons.php">Manage salons</a>
              </li>
            </ul>
            <!-- /nav-second-level -->
          </li>
          ...
          <li>
            <a href="#"><i class="fa fa-check-square-o nav_icon"></i>Customer Details<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level collapse">
